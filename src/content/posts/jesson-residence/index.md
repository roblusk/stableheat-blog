---
title: "Jesson Residence: The Kitchen Is the Argument"
deck: "Of all the rooms a residential radiant install can warm, the Michigan kitchen is the one that justifies the entire project on its own."
...
There's a pattern we've watched repeat across every cold-climate residential install we've done. The homeowner orders radiant for the whole main level, the system goes in, it works as specified, and three months later we get the same email: *"The kitchen is unbelievable. Tell me you can do this in the master bath next year."*

The kitchen wins almost every time. The Jesson Residence in Michigan is a textbook example.

## Why the kitchen is the first room people notice
...
> In a Michigan kitchen, the difference between heated and unheated tile shows up in the first ten seconds of every morning for the rest of the homeowner's life.

## Why the dog moved

This is anecdotal, but it's the most reliable signal we get from residential radiant installs. The household dog finds the warmest spot in the kitchen and adopts it as their permanent station. If the bed used to live in the den, it moves. If the dog used to sleep in the master, they migrate to the kitchen island.

Animals don't care about thermostat readings. They care about surface temperatures. When the kitchen floor jumps from 62°F to 80°F, every four-legged occupant of the house notices within a week.

## Where the kitchen sits in a phased install
...
If you're planning radiant in a cold-climate residential, start where the bare feet land first. That's almost always the kitchen.
