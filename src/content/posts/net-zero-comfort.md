---
title: "Net-Zero Homes Need a Comfort Layer. Radiant Is It."
deck: "The math of net-zero is air-tight. The feel of net-zero is sometimes air-tight too. Radiant fixes the feel."
category: "Solar"
date: 2026-02-20
readTime: "3 min read"
thumbVariant: 8
thumbIcon: "leaf"
excerpt: "Even the best-designed net-zero home has cold spots a heat pump can't reach. A small radiant layer closes the gap."
applications: ["home"]
---
...
The heat pump can't solve those local problems. A thin radiant layer can.

> Heat pumps make the house warm. Radiant makes the rooms feel right.

## The hybrid pattern

For new net-zero builds, the increasingly common pattern is:
...
The all-electric home will only succeed at scale if it actually feels good. Cold tile bathrooms and chilly far-bedroom floors in million-dollar net-zero builds become anti-marketing for the entire approach. Radiant is what closes the gap between the math and the feel.

That's a small detail. It also happens to be the difference between a homeowner who recommends the approach to their neighbors and one who doesn't.
