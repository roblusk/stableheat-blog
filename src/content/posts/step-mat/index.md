---
title: "STEP Mat: Radiant Heat for Renters"
deck: "A self-regulating heating mat you plug into the wall and put under a rug. No installer, no contractor, no flooring tear-up."
category: "Specialty"
date: 2026-04-17
readTime: "4 min read"
thumbVariant: 8
...
Most of what we sell ends up under a finish floor. A contractor pulls the existing flooring, lays our element strips across the substrate, runs the leads to a controller, and puts new tile or wood or vinyl back down on top. The system is invisible from the day it goes in. It's the right answer for almost every permanent installation we touch.

It's the wrong answer for renters.

A renter cannot tear up the floor. A college student in a dorm room cannot call a contractor. A homeowner who doesn't want to renovate the basement office this year cannot justify a permanent heating install for one cold corner. For all of those people, the technology that makes a great floor system also has to come in a form they can plug in tonight.

That form is STEP Mat.
...
There is no installer in that sentence on purpose. The mat is the install.
...
- A bay-window reading nook in an otherwise-conditioned house. One mat under the rug, the seat is warm, the rest of the room runs on building HVAC.
- A mudroom where boots come off in winter. A mat at the entry zone keeps the floor at a temperature that drives moisture off the bottom of the boots before it makes it onto the hardwood.
- A home office over an unconditioned garage. The cold spot under the desk gets a mat. The rest of the office is fine.
- A basement workshop that gets used four months a year. A mat at the workbench makes it usable without conditioning the whole basement.
- A dorm room at a school in a cold climate. The lease prohibits modifications. The mat goes under the rug.

In all of those cases, the alternative is either nothing or a forced-air space heater pointed at the user's ankles. The mat is the answer that doesn't require either.
