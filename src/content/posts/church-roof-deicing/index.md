...
thumbVariant: 5
thumbIcon: "icicles"
excerpt: "A partnership project with Warmzone protecting a church roof from ice-dam damage with self-regulating heat trace at the eaves and gutters."
...
## What ice dams do to a heritage roof

The mechanism is the same as on any other building, but the consequences scale up. Snow accumulates on the upper roof, where the building's interior heat thaws the underside. Meltwater runs down to the eave, hits the unheated overhang, and refreezes. The dam grows backward. Eventually it lifts the shingles, finds the underlayment, and water enters the building.

In a residential home, you patch the ceiling. In a church, you potentially destabilize a hundred-year-old structural detail and damage finish elements that no contractor in the area can replace.

> A roof system that prevents the dam from forming is the only intervention that protects the building.

## The system Warmzone and StableHeat installed

The project covers the church's eaves, valleys, and gutters with self-regulating heat trace cable. The system has two operating modes:
...
- Stewards (vestry, board members, facilities staff) who care about the building beyond the financial calculus

Self-regulating roof deicing is the right intervention for almost all of them. It prevents a problem that's catastrophic if it happens. It runs cheaply when it does run. And it can usually be retrofitted to an existing roof during a routine reroof, without specialized structural work.

If you steward a heritage building of any kind, this is the system to ask about before the next hard winter.
