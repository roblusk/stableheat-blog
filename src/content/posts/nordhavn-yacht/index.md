---
title: "Nordhavn Expedition Yachts: Radiant Across the Oceans"
deck: "Nordhavn boats cross oceans. Their owners cross seasons. The floors stay warm regardless."
category: "Marine"
date: 2025-12-07
readTime: "3 min read"
thumbVariant: 4
...
A weekend cruiser doesn't really need radiant heat. The boat is dockside in winter, the air conditioning runs in summer, and the brief shoulder-season cruises happen at temperatures the existing HVAC handles without thought.

A Nordhavn is different. Owners are at sea for weeks at a time, often crossing latitudes that go from 75°F equatorial waters to 35°F polar conditions on the same passage. The boat has to handle both. Forced-air HVAC works for cooling. For heat, especially in the high latitudes, it leaves significant gaps:
...
> Nordhavn customers don't buy boats to spend the winter dockside. They buy them to keep going.
...
Pacific Asian Enterprises is a serious shipbuilder. Their owners hold them to a serious standard. We're proud to be in the spec on multiple hulls, and we work directly with PAE's design team on each new build to integrate the heating layout with the vessel's overall systems.

For Nordhavn owners considering a new build or a refit: the conversation is the same one we have with custom yacht builders worldwide. Get the radiant in during construction. The cost is incremental. The comfort difference is the entire point of the boat.
