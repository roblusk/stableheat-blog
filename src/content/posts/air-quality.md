...
## Radiant doesn't move anything

A StableHeat floor heats by radiation and conduction. The element warms the floor surface, which warms the people and objects in the room. There's no blower, no return grille, no duct run through a crawl space full of insulation fiber. The air in the room gets warmer, but it stays where it is.

For anyone with allergies, asthma, or simple dust sensitivity, this is a bigger deal than it sounds. Customers tell us they notice the difference fastest at night, when the forced-air system they were using before used to cycle at 3 a.m. and launch eight hours' worth of settled dust back into the bedroom air.

> You stop noticing your HVAC. Which turns out to be the nicest thing an HVAC system can do.

## Humidity stays where it should

Forced-air heating is desiccating. Every time the blower runs, it pulls moisture out of the room along with the heat. That's why winter HVAC season is also chapped-lip season, and why every home-decor magazine recommends humidifiers from November through March.

Radiant doesn't desiccate. The room holds its natural humidity, and for many homeowners, an ERV or a dedicated humidifier simply becomes unnecessary. The baseline comfort is just... better.

## What the evidence says

Studies on radiant heating and indoor air quality are converging on a few consistent findings: lower airborne particulate counts, reduced humidity loss, lower VOC mobilization, and measurable reductions in allergy symptoms among sensitive occupants. None of this is revolutionary. It's the predictable result of *not* running a blower.
